...
export const projectData = [
  ...
  },
  {
    ...
    title: 'Listy Flix',
    description:
      "A front-end web app that makes third party API calls to OMDB's extensive database to provide the user with information from their favorite movies",
    repo: 'https://github.com/ThatZiro/Listy-Flix',
